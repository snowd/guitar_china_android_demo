...
public final class Constants {
	...
	/** 服务器IP */
	public static final String HOST = "bbs.guitarchina.com";//www.shopnctest.com//"10.0.2.2";//AVD test
	/** 服务器端口号 */
	public static final String PORT = "80";
	/** 应用上下文名 */
	public static final String APP = "/app_json";///dx2app/app2//"/app_mob";//
	/** 应用上下文完整路径 */
...
//	public static final String URL_COMMON_TOPIC_LIST = URL_CONTEXTPATH + "/topiclist.php?";
	public static final String URL_COMMON_TOPIC_LIST = URL_CONTEXTPATH + "/index.php?";

	/** 请求参数名：类型 */
//	public static final String PARAM_TYPE = "type";
	public static final String PARAM_TYPE = "action";
	/** 请求参数名：当前页号 */
	public static final String PARAM_PAGENO = "page";
	/** 请求参数名：每页显示记录数 */
	public static final String PARAM_PAGESIZE = "pagesize";
	
	/************************ 二级栏目名称 ***************************************/
//	public static final String URL_TOP_NAME = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=top_name_list";
	public static final String URL_TOP_NAME = URL_COMMON_TOPIC_LIST;
	/************************ 版块主题分类 ***************************************/
	 ...
	 * http://bbs.guitarchina.com/post.php?action=smilies&stypeid=2&inajax=1&scrollt=0&page=2
	 */
	public static final String URL_SMILEY = URL_CONTEXTPATH + "/post.php?" + PARAM_TYPE +"=smilies";
