...
public class TopicItem implements Serializable {
	...
	public static ArrayList<TopicItem> newInstanceList(String jsonDatas){
		try {
	...
	public static ArrayList<TopicItem> newInstanceList(JSONArray arr){
		if (arr == null || arr.length() < 1) return null;
		ArrayList<TopicItem> pushDatas = new ArrayList<TopicItem>();
		try {
//			JSONArray arr = new JSONArray(jsonDatas);
			...
			for(int i = 0; i < size; i++){
				...
				pushDatas.add(new TopicItem(tid, fid,pid, subject, authorid, author,
	...
	public TopicItem(long tid, String subject, String summary, String image) {
		this.tid = tid;
	...
	public TopicItem(long tid, String subject, String author, String views,
	...
	public TopicItem(long tid, long fid, long pid, String subject, String authorId, String author,
	...
	public String toString() {
		return "TopicItem [tid=" + tid + ", fid=" + fid + ", subject=" + subject
