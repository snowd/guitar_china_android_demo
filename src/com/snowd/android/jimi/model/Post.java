...
public class Post implements Serializable {
	...
	public static ArrayList<Post> newInstanceList(String jsonDatas){
		try {
	...
	public static ArrayList<Post> newInstanceList(JSONArray arr){
		if (arr == null || arr.length() < 1) return null;
		ArrayList<Post> pushDatas = new ArrayList<Post>();
		try {
//			JSONArray arr = new JSONArray(jsonDatas);
			...
			for(int i = 0; i < size; i++){
				...
				pushDatas.add(new Post(tid, fid,pid, subject, authorid, author,
	...
	public Post(long tid, String subject, String summary, String image) {
		this.tid = tid;
	...
	public Post(long tid, String subject, String author, String views,
	...
	public Post(long tid, long fid, long pid, String subject, String authorId, String author,
